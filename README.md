...
Furthermore, a comparison between [vanilla DQN](https://web.stanford.edu/class/psych209/Readings/MnihEtAlHassibis15NatureControlDeepRL.pdf) and [double DQN](https://arxiv.org/abs/1509.06461) is presented. 
...
1. Clone Udacity's DRLND Repository
...
3. Place the file in the root folder of this repository, and unzip (or decompress) the file. 
